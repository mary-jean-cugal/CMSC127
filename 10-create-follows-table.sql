...
CREATE TABLE follows IF NOT EXISTS(
	...
	following VARCHAR(15)  REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
	follower VARCHAR(15) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
